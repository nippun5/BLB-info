...
def blb():
        ...
        #------------------------------------period--------------------------
        driver.find_element_by_id("np.com.infodev.blb.local:id/fragment_load_information_period_ed").send_keys("5")
        wait                                                                        
        
        #-------------------------------------request amount------------------
        driver.find_element_by_id("np.com.infodev.blb.local:id/fragment_load_information_request_amount_ed").send_keys("50000")
        wait
